...
pub async fn replay_request(req: ReplayRequest) -> Result<ReplayResponse, String> {
    ...
    for (key, value) in req.headers {
        // Skip certain headers that might interfere or cause errors when set manually
...
pub async fn check_proxy_connectivity(proxy_url: String) -> Result<String, String> {
    ...
    // Try to connect to a stable endpoint (e.g., google.com or cloudflare)
    // Using a reliable, globally available endpoint
