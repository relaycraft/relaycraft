...
interface SettingsStore {
    ...
    updateUpstreamProxy: (proxy: { enabled: boolean; url: string; bypass_domains: string }) => Promise<void>;
...
export const useSettingsStore = create<SettingsStore>((set, get) => ({
    config: {
        ...
        always_on_top: false,
        plugin_registry_url: 'https://raw.githubusercontent.com/relaycraft/relaycraft-plugins/main/plugins.json',
