...
interface UIStore {
  ...
  setDraftRulePrompt: (prompt: string | null) => void;
  draftTrafficFilter: string | null;
  setDraftTrafficFilter: (filter: string | null) => void;
...
export const useUIStore = create<UIStore>((set, get) => ({
  ...
  setDraftRulePrompt: (draftRulePrompt) => set({ draftRulePrompt }),
  draftTrafficFilter: null,
  setDraftTrafficFilter: (draftTrafficFilter) => set({ draftTrafficFilter }),
  draftScriptCode: null,
  setDraftScriptCode: (draftScriptCode) => set({ draftScriptCode }),
  marketOpen: false,
  marketType: "plugin",
  setMarketOpen: (open, type) =>
    set((state) => ({
      marketOpen: open,
