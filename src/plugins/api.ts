...
import { Editor, DiffEditor } from '../components/common/Editor';
...
export const createPluginApi = (pluginId: string, silent: boolean = false, i18nNamespace?: string): PluginAPI => {
