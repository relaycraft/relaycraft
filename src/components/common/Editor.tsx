...
export const Editor = (props: any) => {
  ...
  const fgColor = useMemo(
    () => theme?.colors["--color-foreground"] || "var(--color-foreground)",
    [theme],
  );
  ...
  const extensions = useMemo(() => {
    ...
    return exts;
  }, [isDark, bgColor, fgColor, props.language, props.options, fontMono]);
...
export const DiffEditor = (props: any) => {
  ...
  const extensions = useMemo(() => {
    ...
    return exts;
  }, [isDark, bgColor, fgColor, props.language, props.original, fontMono]);
