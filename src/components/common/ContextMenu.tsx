                ...
                {items.map((item, index) => (
                    item.separator ? (
                        ...
                        <button
                            ...
                            className={cn(
                                "flex items-center gap-2 px-2 py-1.5 rounded-md text-system transition-colors w-full text-left",
                                item.disabled
                        ...
                        >
                            {item.icon && (
                                <span className={cn("w-4 h-4 flex items-center justify-center", item.danger ? "text-destructive" : "text-muted-foreground")}>
                                    {item.icon}
                                </span>
                            )}
