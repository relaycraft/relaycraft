...
import { X, CheckCheck, Bell, BellOff, Search, Eraser } from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="h-14 px-4 border-b border-border/40 flex items-center justify-between bg-muted/10">
                            <div className="flex items-center gap-2.5">
                                <Tooltip content={dnd ? t('notifications.enable', 'Enable notifications') : t('notifications.disable', 'Disable notifications')} side="bottom">
                                    <Button
                                        variant="ghost"
                                        size="icon-xs"
                                        onClick={toggleDnd}
                            ...
                            <div className="flex items-center gap-1">
                                {filteredNotifications.length > 0 && (
                                    <>
                                        <Tooltip content={t('notifications.mark_all_read', 'Mark all as read')} side="bottom">
                                            <Button
                                                variant="ghost"
                                                size="icon-xs"
                                        ...
                                        <Tooltip content={t('notifications.clear_all', 'Clear all notifications')} side="bottom">
                                            <Button
                                                variant="ghost"
                                                size="icon-xs"
                                                onClick={clearAll}
