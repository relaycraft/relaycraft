import { Monitor, Smartphone, Globe, Shield, Settings, Wifi, AlertTriangle, MonitorSmartphone } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                    <div className="bg-primary/5 rounded-xl p-3 border border-primary/10">
                        <p className="text-[10px] font-black text-primary/70 uppercase tracking-widest">{t('setup_guide.current_proxy')}</p>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 pb-2 border-b border-border/30">
                            ...
                            <h3 className="font-black text-xs uppercase tracking-wider">{t('setup_guide.pc_config')}</h3>
                        </div>
                            ...
                            <li className="flex gap-3 text-xs text-foreground/90">
                                ...
                                <span>
                                    ...
                                    <p className="mt-1 text-[11px] text-muted-foreground/70 leading-relaxed"
                                        dangerouslySetInnerHTML={{ __html: t('setup_guide.switchy_omega_desc', { ip: localIp, port: proxyPort }) }}
                                    />
                                </span>
                            </li>
                            <li className="flex gap-3 text-xs text-foreground/90">
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-2 pb-2 border-b border-border/30">
                        ...
                        <h3 className="font-black text-xs uppercase tracking-wider">{t('setup_guide.mobile_config')}</h3>
                    </div>
                    <ul className="space-y-5">
                        <li className="flex gap-3 text-xs text-foreground/90">
                            ...
                            <span>
                                ...
                                <p className="mt-1 text-[11px] text-muted-foreground/70 leading-relaxed"
                                    dangerouslySetInnerHTML={{ __html: t('setup_guide.wifi_manual_desc') }}
                                />
                            </span>
                        </li>
                        <li className="flex gap-3 text-xs text-foreground/90">
                            ...
                            <span>
                                ...
                                <p className="mt-1 text-[11px] text-muted-foreground/70 leading-relaxed"
                                    dangerouslySetInnerHTML={{ __html: t('setup_guide.install_cert_desc') }}
                                />
                            </span>
                        </li>
                    </ul>
                    ...
                    <div className="bg-muted/10 rounded-xl p-3 border border-border/20 flex gap-3 mt-4">
                        ...
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-tight text-yellow-500/70">{t('setup_guide.trouble')}</p>
