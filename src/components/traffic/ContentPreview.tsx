  ...
  if (!content) {
    return (
      <div className="flex flex-col items-center justify-center p-6 text-muted-foreground/50 bg-muted/5 rounded-lg border border-border/30 mt-2 h-24">
        ...
        <span className="text-xs font-medium opacity-60">{t("content_preview.no_content")}</span>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-2 h-full">
      <div className="flex items-center justify-between px-1">
        <div className="flex items-center gap-2">
          <span className="px-2 py-1 rounded-md bg-muted text-xs font-bold uppercase tracking-wider text-muted-foreground">
            {contentType}
          </span>
        ...
        <div className="flex items-center gap-2 px-3 py-2 bg-amber-500/10 border border-amber-500/20 rounded-lg text-xs">
          ...
          {!showFullContent && (
            <button
              ...
              className="ml-auto px-2 py-0.5 bg-amber-500/20 hover:bg-amber-500/30 text-amber-600 dark:text-amber-400 rounded text-xs font-medium transition"
            >
          ...
          {showFullContent && (
            <button
              ...
              className="ml-auto px-2 py-0.5 bg-muted hover:bg-muted/80 text-muted-foreground rounded text-xs font-medium transition"
            >
