...
export function LogViewer({ onClose }: LogViewerProps) {
  ...
  return (
    <Modal
      ...
      subtitle={
        <p className="text-tiny text-muted-foreground/60 font-bold tracking-wider uppercase">
          {logType} logs
        </p>
      }
    ...
    >
      ...
      <div className="px-4 py-1.5 bg-muted/10 border-b border-border/20 overflow-x-auto no-scrollbar shrink-0">
