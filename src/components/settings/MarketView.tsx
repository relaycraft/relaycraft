import { Check, Download, ExternalLink, Package, Palette, RefreshCw, Search } from "lucide-react";
...
export const MarketView: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Toolbar */}
      <div className="flex-none px-6 py-3 border-b border-border bg-muted/20">
