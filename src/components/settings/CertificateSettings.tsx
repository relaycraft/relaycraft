...
export function CertificateSettings() {
  ...
  const loadCertInfo = useCallback(
    async (silent = false) => {
  ...
  const handleInstallAutomated = () =>
    handleAction("install", () => invoke("install_cert_automated"));
        ...
        <div className="p-5 space-y-6">
          ...
          <div className="bg-card border border-border rounded-xl p-1 pr-2 flex items-center gap-4 hover:shadow-sm transition-shadow group">
            ...
            <div className="flex items-center gap-2">
              <CopyButton text={certPath || ""} variant="secondary" className="h-8 w-8" />
              <Button
