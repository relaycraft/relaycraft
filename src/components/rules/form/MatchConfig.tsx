          ...
          <div className="flex flex-col gap-2 p-3 bg-muted/20 rounded-xl border border-border/40">
            ...
            <div className="mt-1 space-y-1">
              <div className="flex items-center justify-between">
                ...
                {testUrl && (
                  <div
                    className={`text-xs font-semibold px-1.5 py-0 rounded-full flex items-center gap-1 transition-all duration-300 ${isMatch ? "bg-green-500/10 text-green-500" : "bg-red-500/10 text-red-500"}`}
                  >
                    {isMatch ? (
        ...
        <div className="flex flex-col gap-1">
          <div className="flex flex-wrap gap-2">
            <Button
              ...
              className={cn(
                "font-bold px-2.5 transition-all duration-200",
                methods.length === 0
                  ? "bg-primary/20 text-primary border-primary/30"
                  : "text-muted-foreground/60 border-border/40 hover:text-foreground hover:border-border/60",
              )}
            >
              ANY
            </Button>
