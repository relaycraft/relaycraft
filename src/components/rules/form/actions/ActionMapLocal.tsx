            ...
            <div className="space-y-3">
                <div className="space-y-1.5">
                    ...
                    <SegmentedControl
                        ...
                        options={[
                            { label: t('rule_editor.action.map_local.source_file'), value: 'file' },
                            { label: t('rule_editor.action.map_local.source_manual'), value: 'manual' },
                        ]}
                        value={source}
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Input
                            ...
                            onChange={(e) => {
                                ...
                                onChangeStatusCode(val === '' ? 200 : parseInt(val));
                            }}
