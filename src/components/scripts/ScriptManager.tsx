...
import { Plus, Trash2, FileText, ToggleLeft, ToggleRight, Loader2, RefreshCw, AlertTriangle, X, ScrollText, ChevronUp, ChevronDown } from 'lucide-react';
    ...
    return (
        <div className="h-full flex overflow-hidden">
            ...
            <div className="w-72 border-r border-border bg-muted/40 flex flex-col flex-shrink-0">
                ...
                <div
                    className="flex-1 overflow-y-auto p-2 space-y-1 pt-2"
                >
                    {draftScript && (
                        <div
                        ...
                        >
                            ...
                            <button
                                onClick={(e) => { e.stopPropagation(); setDraftScript(null); }}
                    ...
                    {loading && scripts.length === 0 ? (
                        <div className="flex justify-center p-4"><Loader2 className="animate-spin w-4 h-4 text-muted-foreground" /></div>
                    ) : scripts.length === 0 ? (
                        <EmptyState
                            icon={ScrollText}
                        ...
                        scripts.map((script) => (
                            <div
                                ...
                                className={`group flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer text-system transition-all border ${selectedScript === script.name
                            ...
                            >
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <div className="relative">
                                            <div className={`w-2 h-2 rounded-full flex-shrink-0 transition-colors ${script.enabled
                                ...
                                <FileText className={`w-4 h-4 flex-shrink-0 ${script.enabled ? 'text-foreground' : 'opacity-50'}`} />
                                ...
                                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0 ml-auto">
                                    ...
                                    <Tooltip content={script.enabled ? t('common.disable') : t('common.enable')}>
                                        ...
                                        >
                                            {script.enabled ? <ToggleRight className="w-5 h-5" /> : <ToggleLeft className="w-5 h-5" />}
                                        </button>
                                    </Tooltip>
