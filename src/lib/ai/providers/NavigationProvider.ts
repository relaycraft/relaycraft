    ...
    const navCommands = [
      {
        id: "nav_traffic",
        action: "/traffic",
        label: t("command_center.suggestions.nav_traffic"),
        name: t("sidebar.traffic"),
      },
      {
        id: "nav_rules",
        action: "/rules",
        label: t("command_center.suggestions.nav_rules"),
        name: t("sidebar.rules"),
      },
      {
        id: "nav_scripts",
        action: "/scripts",
        label: t("command_center.suggestions.nav_scripts"),
        name: t("sidebar.scripts"),
      },
      {
        id: "nav_composer",
        action: "/composer",
        label: t("command_center.suggestions.nav_composer"),
      ...
      },
      {
        id: "clear",
        action: "/clear",
        label: t("command_center.suggestions.clear"),
        name: t("command_center.actions.clear_traffic"),
      },
    ];
