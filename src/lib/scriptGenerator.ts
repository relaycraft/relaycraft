...
/**
 * Generates mitmproxy Python script
 */
/**
...
`
  ...
  actions.forEach((action) => {
    if (action.type === "map_local") {
      ...
      // Engine throttle applies to request
...
function generateMatchLogic(rule: Rule, _indent: string): string {
  ...
  const atoms = [...(match.request || []), ...(match.response || [])]; // Simplify: usually match request
